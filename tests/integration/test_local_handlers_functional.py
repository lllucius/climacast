...
def test_cache_handler_functional():
    ...
    # Test location cache
    location_data = {"lat": 40.7128, "lon": -74.0060, "city": "New York"}
    ...
    assert os.path.exists(
        os.path.join(test_cache_dir, "location")
    ), "Location subdirectory not created"
    ...
    # Test zone cache
    zone_data = {"zone": "NYZ072", "name": "New York City"}
